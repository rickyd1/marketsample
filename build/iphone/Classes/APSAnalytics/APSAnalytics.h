 ...
 * to send analytic data that can be viewed on the HawaiiFarmersMarketGuide Dashboard.
 *
 * For information on getting started with HawaiiFarmersMarketGuide Platform Services,
