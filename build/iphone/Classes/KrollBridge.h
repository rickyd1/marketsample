...
@interface HawaiiFarmersMarketGuideObject : KrollCoverageObject {
#else
@interface HawaiiFarmersMarketGuideObject : KrollObject {
#endif
@private
...
extern NSString * HawaiiFarmersMarketGuide$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	HawaiiFarmersMarketGuideObject *_hawaiifarmersmarketguide;
    KrollObject* console;
	BOOL shutdown;
