...
//@interface HawaiiFarmersMarketGuideObject : NSObject
//@end

@interface HawaiiFarmersMarketGuideObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HawaiiFarmersMarketGuideObject class]])
		{
			for (NSString *key in [[(HawaiiFarmersMarketGuideObject*)o modules] allKeys])
			{
