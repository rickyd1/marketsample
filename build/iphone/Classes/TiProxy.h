...
//Rare exceptions to indicate a bug in the _hawaiifarmersmarketguide code (Eg, function that a subclass should have implemented)
...
/**
 The base class for HawaiiFarmersMarketGuide proxies.
 */
