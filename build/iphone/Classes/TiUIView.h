...
/**
 Base class for all HawaiiFarmersMarketGuide views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the HawaiiFarmersMarketGuide view hierarchy (such as wrapped iOS UIViews) was touched.
