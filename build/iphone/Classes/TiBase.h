...
// in simulator we redefine to format for HawaiiFarmersMarketGuide Developer console
...
{\
	NSString * exceptionName = [@"org.hawaiifarmersmarketguide." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hawaiifarmersmarketguide";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHawaiiFarmersMarketGuideNativeItemNone = -1, 
	UIHawaiiFarmersMarketGuideNativeItemSpinner = -2,
	UIHawaiiFarmersMarketGuideNativeItemProgressBar = -3,
	
	UIHawaiiFarmersMarketGuideNativeItemSlider = -4,
	UIHawaiiFarmersMarketGuideNativeItemSwitch = -5,
	UIHawaiiFarmersMarketGuideNativeItemMultiButton = -6,
	UIHawaiiFarmersMarketGuideNativeItemSegmented = -7,
	
	UIHawaiiFarmersMarketGuideNativeItemTextView = -8,
	UIHawaiiFarmersMarketGuideNativeItemTextField = -9,
	UIHawaiiFarmersMarketGuideNativeItemSearchBar = -10,
	
	UIHawaiiFarmersMarketGuideNativeItemPicker = -11,
	UIHawaiiFarmersMarketGuideNativeItemDatePicker = -12,
	
	UIHawaiiFarmersMarketGuideNativeItemInfoLight = -13,
	UIHawaiiFarmersMarketGuideNativeItemInfoDark = -14,
	
	UIHawaiiFarmersMarketGuideNativeItemDisclosure = -15,
	
	UIHawaiiFarmersMarketGuideNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all HawaiiFarmersMarketGuide instances of
